        ...
        return (
            `
                ...
                window.onload = () => {
                    ...
                    //initialize names (random generator)
                    _createRandomNames();
                ...
                _createRandomNames = () => {
                    ...
                    */
                    ...
                    //create a random name for the workspace and the attendee - capitalize the first letter
                    const wsName1 = adjectives[Math.floor(Math.random() * adjectives.length)];
                    const wsName2 = adjectives[Math.floor(Math.random() * adjectives.length)];
                    
                    const attndName1 = nouns[Math.floor(Math.random() * nouns.length)];
                    const attndName2 = nouns[Math.floor(Math.random() * nouns.length)];
                    const attndName = attndName1[0].toUpperCase() + attndName1.substr(1) + ' ' + attndName2[0].toUpperCase() + attndName2.substr(1)

                    //assign values
                    $('#create-ws-name').val(wsName1[0].toUpperCase() + wsName1.substr(1) + ' ' + wsName2[0].toUpperCase() + wsName2.substr(1));
                    $('#create-attnd-name').val(attndName);
                    $('#join-attnd-name').val(attndName);
                };
            `
        );
    };
        ...
        return (
            `
                ...
                <div id='welcome' class='active-route'>
                                    ...
                                    <div class="card-body">
                                        <form name='create-ws' method='post' action='#' onsubmit='return(false);'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type='text' name='create-attnd-name' id='create-attnd-name' minlength='2' maxlength='50' required/>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <form name='join-ws' method='post' action='#' onsubmit='return(false);'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type='text' name='join-attnd-name' id='join-attnd-name' minlength='2' maxlength='50' required/>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="container-fluid text-center" style="position:fixed; background-color: rgba(0, 0, 0, 0.05); bottom:0; font-size:12px;">
