            ...
            `
                ...
                _createRandomNames = () => {
                    ...
                    */
                    ...
                    //create a random name for the workspace and the attendee
                    const wsName = adjectives[Math.floor(Math.random() * adjectives.length)] + ' ' + nouns[Math.floor(Math.random() * nouns.length)];
                    const attndName = adjectives[Math.floor(Math.random() * adjectives.length)] + ' ' + nouns[Math.floor(Math.random() * nouns.length)];

                    //assign values
                    $('#create-ws-name').val(wsName);
